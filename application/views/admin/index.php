                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white"><?= $this->Model_User->getUserWhere(['role_id' => 1])->num_rows(); ?>
                            </div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?php
                                $where = ['stok != 0'];
                                $totalstok = $this->Model_Buku->total(
                                    'stok',
                                    $where
                                );
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?php
                                $where = ['dipinjam != 0'];
                                $totaldipinjam = $this->Model_Buku->total(
                                    'dipinjam',
                                    $where
                                );
                                echo $totaldipinjam;
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?php
                                $where = ['dibooking !=0'];
                                $totaldibooking = $this->Model_Buku->total('dibooking', $where);
                                echo $totaldibooking;
                                ?>
                            </div>
                        </div>
    ...
    <div class="col">
        <div class="table-responsive table-bordered ml-auto mr-auto mt-2">
            <div class="page-header">
                <span class="fas fa-users text-primary mt-2 ml-2"> Data User</span>
                <a class="text-danger" href="<?= base_url('user/data_user'); ?>">
                    <i class="fas fa-search mt-2 mr-2 float-right"> Tampilkan</i>
                </a>
            </div>
            <table class="table mt-3">
                ...
                <tbody>
                    <?php
                    $i = 1;
                    // $anggota = $this->Model_User->getUserLimit();
        ...
        <div class="table-responsive table-bordered ml-auto mrauto mt-2">
            <div class="page-header">
                <span class="fas fa-book text-warning mt-2 ml-2"> Data Buku</span>
                <a href="<?= base_url('buku'); ?>">
                    <i class="fas fa-search text-primary mt-2 mr-2 float-right"> Tampilkan</i>
                </a>
            </div>
